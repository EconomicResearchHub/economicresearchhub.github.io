...
immigown_chart <- highchart() %>%
  hc_chart(type = "bar",  zoomType = "xy") %>%
  hc_title(
    text = "The gender gap was proportionally higher among the Black population, but continues to be significant amongst both White and other racialized business owners.",
    align = "center"
  ) %>%
  hc_subtitle(
