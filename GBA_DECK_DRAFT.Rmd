...
immigown_chart <- highchart() %>%
  hc_chart(type = "bar",  zoomType = "xy") %>%
  hc_title(
    text = "The gender gap in terms of firm ownership was disproportionally higher among the Black population, but continues to be significant amongst both White and other racialized business owners.",
    align = "center"
  ) %>%
  hc_subtitle(
...
patents_chart <- highchart() %>%
  hc_chart(type = "bar", stacked = TRUE, zoomType = "xy") %>%
  hc_title(
    text = "Men-owned businesses were 16.5 percentage points more likely to have conducted R&D, and, conditional on conducting R&D, spent 70% more. ",
    align = "center"
  ) %>%
  hc_subtitle(
