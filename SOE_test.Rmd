...
1. More structures, machines, and intangible assets <strong>(capital deepening).</strong>

 <span style="font-size: 15px;"> 
2.More skills <strong>(skills composition of labour force)</strong>.

 <span style="font-size: 15px;"> 
3.More effective use of the above inputs <strong(total factor productivity)</strong>
</span>
-<span style="font-size: 18px;"> 
...
<div class="chart">
```{r,echo=FALSE,results='asis',fig.width=3.5, fig.height=3.}
...
<div class="charts-container">
```{r,echo=FALSE,results='asis',fig.width=5.5, fig.height=3.}
# Assuming the chart object is created and named capital_deepening_chart
capital_deepening_chart
```
```{r,echo=FALSE,results='asis',fig.width=5.5, fig.height=3.}
