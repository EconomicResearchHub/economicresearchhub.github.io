...
<strong>  Canadian economy facing multiple headwinds pointing to slow economic activity </strong>in the first half of 2024.
...
<ul style="font-size: 24px;">
 0.3% GDP contraction in the third quarter as the effects of higher interest rates trickle through the economy.</ul>
...
- <span style="font-size: 22px;"> 
<strong>Effects of interest rate increases expected to continue </strong>to restrain spending, while limiting growth and employment. 
...
Current federal debt 42 of GDP, places Canada with third lowest public debt to GDP ratio among G 7 above the UK and Germany Fiscal anchor calls for deficits no larger than 1% of GDP
```{r, echo=FALSE, fig.width=6, fig.height=5.15}
...
- <span style="font-size: 22px;"> 
The Bank of Canada’s <strong>housing affordability index reached its highest level </strong> since 1982 — worst degree of affordability .
...
- <span style="font-size: 22px;"> 
Overall, <strong>shelter costs (e.g. mortgage and rent payments) are up by nearly 6% </strong> in the past year, ~twice the overall inflation rate.

- <span style="font-size: 22px;"> 
<strong>CPI – food purchased from stores was 4.7% in December</strong>, similar to November. That said, grocery prices had decelerated for five consecutive months.
...
- <span style="font-size: 22px;"> 
<strong>Labour costs rose faster than the increase in price of the products </strong>sold for the better part of the year.

- <span style="font-size: 22px;"> 
Though faster wage increases are an understandable reaction to higher inflation, they risk making a <strong>return to low inflation more difficult.</strong>


</span>
]
```{r, echo=FALSE, fig.align='center', fig.width=12, fig.height=5.80, warning=FALSE}
...
const <- highchart() %>%
  ...
  labels = list(
    list(
      ...
      text = "Recent uptick    </br>
      in prices",
      crop=FALSE,
      draggable = TRUE,  # Set draggable to TRUE or FALSE
      labelOptions = list(
        shape = 'connector',
        align = 'right',
        justify = FALSE,
...
.pull-right[
```{r, echo=FALSE, fig.align='center', fig.width=8.3, fig.height=6.75}
const
```
]
<div class="subpoints" style="position: absolute; top: 0; left: 0; width: 100%; padding: 10px; background-color: #A4B9CE; text-align: center;">
...
- <span style="font-size: 22px;"> 
Since 2020, <strong> output per hour in the business sector has dropped at an annual rate of 0.2% –</strong> the first negative reading on record over such a sustained period (see chart). 


- <span style="font-size: 22px;"> 
Canada’s <strong>labour productivity gap with the U.S. further deteriorated – </strong>as of 2022, Canada was 72% as productive as the U.S., falling from 75%. 

</span>
]
.pull-right[
```{r, echo=FALSE, fig.align='center', fig.width=8.3, fig.height=6.95}
...
lp_chart<- highchart() %>%
  ...
  labels = list(
    list(
      ...
      text = "The productivity gap between  ,</br />Canada 
                and the U.S. increasing    .<br />",
      draggable = FALSE,  # Set draggable to TRUE or FALSE
      labelOptions = list(
        shape = 'connector',
        align = 'left',
...
<ul style="font-size: 22px;"> 
  <li>
    Canada's low/declining relative labor productivity to the U.S. is driven by <strong>weakness in total factor productivity growth,</strong> which has not improved in decades.   
...
.pull-left[
- <span style="font-size: 22px;"> 
<strong>It is not just an R&D story - Canadian businesses invest proportionally less </strong>in machinery & equipment (M&E)and other Intellectual Property Products (IPP) (e.g., software and data).
</span>
  
- <span style="font-size: 22px;">
Bank of Canada’s latest Business Outlook Survey shows many <strong>Canadian businesses are preparing to invest less in M&E </strong>over the coming year.


- <span style="font-size: 22px;">
<strong>Investing in technologies </strong>and the knowledge and skills to effectively use them, <strong>contributes positively to productivity growth,</strong> supporting a healthy innovation ecosystem - critical for economic growth and competitiveness. 
</span>
<center>
<img src="rnd.jpg" width="105%"/>
</center>
]
.pull-right[
<ul style="font-size: 20px;">
<center>
<strong>Gross fixed capital formation by asset category, % of GDP</strong></ul>
</center>
.pull-left[
```{r,echo=FALSE,results='asis',fig.width=3.5, fig.height=5.235}
m_e_chart
```
]
.pull-right[
```{r,echo=FALSE,results='asis',fig.width=4, fig.height=4.85}
non_res_chart
```
]
]
...
<ul style="font-size: 22px;"> 
  <li>
<strong>Well-formulated environmental policies and programs can spur innovation, </strong>which can in turn stimulate productivity.
  </li>
 </ul>
 
<ul style="font-size: 20px;"> 
  <li>
Emerging evidence in Canada suggests that the <strong>environmental and clean technology sector is generating above-average productivity returns. </strong>
  </li>
</ul>

<ul style="font-size: 20px;"> 
  <li>
A recent study found that businesses getting clean-tech support: 
    <ul>
      <li>had a more educated workforce;</li>
      <li>faster labour productivity growth;</li>
      <li>faster revenue growth, and;</li>
      <li>faster employment growth. </li>
    </ul>
  </li>
</ul>
]
...
- <span style="font-size: 22px;"> 
<strong>Small-Medium Sized firms (SMEs),</strong> majority of the Canadian economy, <strong>continue to lag larger firms in the use of foundational technologies</strong> (e.g., e-commerce). 
...
<ul style="font-size: 24px;">
Shortages can be good news for productivity.</ul>

.pull-left[

- <span style="font-size: 22px;"> 
Job vacancies <strong>edged up to 653,005 in November 2023,</strong> remaining well above pre-COVID-19 levels.
...
Economic headwinds likely to result in slower economic activity in the near-term. <strong>ISED policies and programs to prepare for different economic downturn scenarios</strong> within a tight fiscal environment. 


- <span style="font-size: 25px;"> 
<strong>Elevated interest rates and ongoing significant affordability challenges continue to weigh on Canadian households, </strong>consumers and businesses, with recent drops in productivity effectively erasing five years of gains.<strong> ISED to continue looking at how various policy levers can be deployed to help solve the productivity puzzle.  </strong>


- <span style="font-size: 25px;"> 
Low investment in R&D and innovation-enhancing activities also expected to weigh on economic growth. <strong>ISED policies to  continue to seek to accelerate incent/innovation,</strong> including technology adoption and intangible assets, <strong>to lift productivity growth.</strong>
