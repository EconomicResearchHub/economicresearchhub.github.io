...
```{r, echo=FALSE,  include=FALSE, fig.align='center', fig.width=4, fig.height=3}
...
<div class="col" style="flex: 10%; padding: 3px;">
```{r, echo=FALSE,results='asis',fig.width=4, fig.height=3.95}
capital_deepening_chart
```
</div>
<div class="col"style="flex: 10%; padding: 3px;">
...
<!-- Bottom Right Charts Container -->
<div class="bottom-right-container">
  <div class="chart-container side-chart-container">

```{r,echo=FALSE,results='asis',fig.width=3.5, fig.height=3.5}
# Assuming the chart object is created and named capital_deepening_chart
capital_deepening_chart
```
