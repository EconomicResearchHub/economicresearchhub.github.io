...
lp_chart<- highchart() %>%
  ...
  labels = list(
    list(
      ...
      text = "The productivity gap between Canad   a,</br />
...
<span style="font-size: 25px;"> 
Note that the hub is also available through the homepage of [ISEDWeb](https://033gc.sharepoint.com/sites/EconomicResearchandAnalysisERA/SitePages/Home%20Page.aspx?from=SendByEmail&e=wAEAyo9qXE20Vlezw85pIw&at=9).
