...
```{r,echo=FALSE,results='asis',fig.width=6, fig.height=3.2}
# Assuming the chart object is created and named capital_deepening_chart
capital_deepening_chart
```
```{r,echo=FALSE,results='asis',fig.width=6, fig.height=2.25}
...
<strong>Canada invests relatively less in M&E / IPP 
</strong>
...
<div class="charts-container">
```{r,echo=FALSE,results='asis',fig.width=6.5, fig.height=3.45}
lp_chart
```
```{r,echo=FALSE,results='asis',fig.width=6.5, fig.height=2.65}
rg_chart
```
```{r,echo=FALSE,results='asis',fig.width=6.5, fig.height=3.05}
eg_chart
```
</div>
]
